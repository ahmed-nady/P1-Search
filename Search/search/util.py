...
class PriorityQueue:
    ...
    def getStateDetails(self,item):
          for index, (p, c, i) in enumerate(self.heap):
              state,path,cost = i
              if state == item:
                  return [cost,p,path] #first parameter is the cost abd second is the priority and third is the path
          return []
